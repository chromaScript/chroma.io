...
int In_Draw::move(Application* sender, MouseEvent dat)
{
	//std::cout << "IN_DRAW::MOVE" << std::endl;
	...
	anchorIDCount++;
	fragData.anchors.push_back(FragmentAnchor(data.start.flag, anchorIDCount, pos, dir, 1.0f,
...
int In_Draw::click(Application* sender, MouseEvent dat)
{
	int wasHandled;
