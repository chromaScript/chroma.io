...
#include "../../../include/tool/toolSettings/effects/TSet_FX_HSV.h"
...
TSetControl_Node* TSet_FX_HSV::getControlNode(int settingSig, int subSig)
{
	return nullptr;
}
TSetController* TSet_FX_HSV::getController(int settingSig, int subSig)
{
	return nullptr;
}
TSetGraph* TSet_FX_HSV::getGraph(int settingSig, int subSig)
{
	return nullptr;
}
TSetNoise* TSet_FX_HSV::getNoise(int settingSig, int subSig)
{
	return nullptr;
}
