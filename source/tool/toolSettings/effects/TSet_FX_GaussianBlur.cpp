...
#include "../../../include/tool/toolSettings/effects/TSet_FX_GaussianBlur.h"
...
TSetControl_Node* TSet_FX_GaussianBlur::getControlNode(int settingSig, int subSig)
{
	return nullptr;
}
TSetController* TSet_FX_GaussianBlur::getController(int settingSig, int subSig)
{
	return nullptr;
}
TSetGraph* TSet_FX_GaussianBlur::getGraph(int settingSig, int subSig)
{
	return nullptr;
}
TSetNoise* TSet_FX_GaussianBlur::getNoise(int settingSig, int subSig)
{
	return nullptr;
}
