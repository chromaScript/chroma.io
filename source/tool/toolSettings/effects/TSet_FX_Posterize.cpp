...
#include "../../../include/tool/toolSettings/effects/TSet_FX_Posterize.h"
...
TSetControl_Node* TSet_FX_Posterize::getControlNode(int settingSig, int subSig)
{
	return nullptr;
}
TSetController* TSet_FX_Posterize::getController(int settingSig, int subSig)
{
	return nullptr;
}
TSetGraph* TSet_FX_Posterize::getGraph(int settingSig, int subSig)
{
	return nullptr;
}
TSetNoise* TSet_FX_Posterize::getNoise(int settingSig, int subSig)
{
	return nullptr;
}
