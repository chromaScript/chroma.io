...
#include "../../../include/tool/toolSettings/method/TSet_Field.h"
...
TSetControl_Node* TSet_Field::getControlNode(int settingSig, int subSig)
{
	return nullptr;
}
TSetController* TSet_Field::getController(int settingSig, int subSig)
{
	return nullptr;
}
TSetGraph* TSet_Field::getGraph(int settingSig, int subSig)
{
	return nullptr;
}
TSetNoise* TSet_Field::getNoise(int settingSig, int subSig)
{
	return nullptr;
}