...
//Constructor
Image::Image(std::map<std::string, std::string> basicAttribs,
...
// Dimension Functions
glm::ivec2 Image::getSizeByChildren()
{
...
glm::ivec2 Image::getSizeByParent()
{
	glm::ivec2 report = setSizeByParent();
	sizeX = report.x;
	sizeY = report.y;
...
glm::ivec2 Image::findWidgetLocation(std::shared_ptr<Widget> childWidget)
{
...
// Render Functions
void Image::drawSelf(ShaderTransform xform)
{
