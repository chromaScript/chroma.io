...
void GradientBox::buildWidget()
{
	...
	glVertexAttribPointer(1, 4, GL_FLOAT, GL_FALSE, gbAttribStride, (void*)gbVCAttribOffset);
	glEnableVertexAttribArray(1);
	// Set texture coordinate attribute
	glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, gbAttribStride, (void*)gbTCAttribOffset);
